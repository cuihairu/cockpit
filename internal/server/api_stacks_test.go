...
func TestParseStacksRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		{"restart", http.MethodPost, "/api/stacks/agents/a1/web/restart", http.StatusNotFound},
		{"pull", http.MethodPost, "/api/stacks/agents/a1/web/pull", http.StatusNotFound},
		{"history", http.MethodGet, "/api/stacks/agents/a1/web/history", http.StatusOK},
		{"history wrong method", http.MethodPost, "/api/stacks/agents/a1/web/history", http.StatusMethodNotAllowed},
